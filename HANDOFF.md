...
**Rich Menu — สร้างและอัปโหลดรูปแล้ว แต่ยังไม่ได้ตั้งเป็นเมนูหลัก (ยังไม่โชว์ให้ลูกค้าเห็น)**
สร้างริชเมนู 6 ปุ่ม (จองห้องพัก, การจองของฉัน, รูปห้องพัก, แผนที่/เส้นทาง, โทรติดต่อเรา, ติดต่อแอดมิน) — richMenuId: `richmenu-bf5d695b650cd5bd2729f5c903d4a959` — **จงใจยังไม่ตั้งเป็นเมนูหลัก** เพราะปุ่ม "แผนที่" ยังชี้ไป placeholder (รอลิงก์ Google Maps จริงจากบอสตอง) — พอได้ลิงก์แผนที่จริงแล้วจะสร้างเมนูใหม่พร้อมลิงก์ที่ถูกต้องแล้วค่อยตั้งเป็นเมนูหลักให้เลย ไม่ต้องทำอะไรตอนนี้
