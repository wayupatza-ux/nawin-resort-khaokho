...
ริชเมนู 6 ปุ่ม (จองห้องพัก, การจองของฉัน, รูปห้องพัก, แผนที่/เส้นทาง, โทรติดต่อเรา, ติดต่อแอดมิน) — richMenuId ปัจจุบัน: `richmenu-50483ae581802d96f45d357400d8ee59` (ชื่อ "Nawin Resort Khaokho - main v3 (liff links)") ตั้งเป็นเมนูหลักแล้ว ลูกค้าเห็นทันทีที่เปิดแชท OA
...
**ยังไม่ทดสอบจริงหลังแก้ทั้ง 2 บั๊ก — บอสตองควรลองกดปุ่ม "จองห้องพัก" จากแอป LINE จริงอีกครั้งเพื่อยืนยันว่า login ผ่านแบบไม่มี error แล้ว** ก่อนถือว่าปิดเคสนี้สมบูรณ์ (คาดว่าน่าจะผ่านแล้วเพราะแก้ครบทั้ง URL รูปแบบลิงก์ + สถานะ channel)
